...
module fan_edges(radius=44, screw_hole_radius=2.2, hole_offset=5) {
    difference() {
...
module repeated_fan_edges(radius=44, n_fans=2, screw_hole_radius=2) {
    for (i = [0:n_fans-1]) {
...
module frame(radius=44, n_fans=2, screw_hole_radius=2.2) {
    length = 100 * n_fans - 5;
